...
class TestCases(unittest.TestCase):
    ...
    def test_test_population_by_education2(self):
    ...
    def test_population_by_poverty(self):
        input = [reduced_data[0],reduced_data[1]]
    ...
    def test_percent_by_education(self):
        ...
        expected = 17.4224
        end = math.isclose(expected,result,abs_tol=0.005,rel_tol=0.005)
        self.assertEqual(True,end)
    ...
    def test_education_greater_than2(self):
        input = [reduced_data[0],reduced_data[1]]
        result = hw3.education_greater_than(input, "Bachelor's Degree or Higher", 0.0)
        expected = [reduced_data[0],reduced_data[1]]
        self.assertEqual(expected,result)
    # test education_less_than
    def test_education_less_than1(self):
        input = [reduced_data[0],reduced_data[1]]
        result = hw3.education_less_than(input, "Bachelor's Degree or Higher", 5.0)
        expected = [reduced_data[0],reduced_data[1]]
        self.assertEqual(expected,result)

    def test_education_less_than1(self):
        input = [reduced_data[0],reduced_data[1]]
        result = hw3.education_less_than(input, "Bachelor's Degree or Higher", 100.0)
        expected = [reduced_data[0],reduced_data[1]]
        self.assertEqual(expected,result)
    # test ethnicity_greater_than
    def test_ethnicity_greater_than(self):
        input = reduced_data
        result = hw3.ethnicity_greater_than(input, "Hispanic or Latino", 10.0)
        expected = [reduced_data[2],reduced_data[3]]
        self.assertEqual(expected,result)

    def test_ethnicity_greater_than(self):
        input = reduced_data
        result = hw3.ethnicity_greater_than(input, "Hispanic or Latino", 100.0)
        expected = []
        self.assertEqual(expected, result)
    ...
    def test_ethnicity_less_than(self):
        input = reduced_data
        result = hw3.ethnicity_less_than(input, "Hispanic or Latino", 100.0)
        expected = reduced_data
        self.assertEqual(expected, result)

    def test_ethnicity_less_than(self):
        input = reduced_data
        result = hw3.ethnicity_less_than(input, "Hispanic or Latino", 0.0)
        expected = []
        self.assertEqual(expected, result)
    # test below_poverty_level_greater_than
    def test_below_poverty_level_greater_than(self):
        input = reduced_data
        result = hw3.below_poverty_level_greater_than(input, 5.0)
        expected = reduced_data
        self.assertEqual(expected, result)

    def test_below_poverty_level_greater_than(self):
        input = reduced_data
        result = hw3.below_poverty_level_greater_than(input, 90.0)
        expected = []
        self.assertEqual(expected, result)
    # test below_poverty_level_less_than
    def test_below_poverty_level_less_than(self):
        input = reduced_data
        result = hw3.below_poverty_level_less_than(input, 90.0)
        expected = reduced_data
        self.assertEqual(expected, result)

    def test_below_poverty_level_less_than(self):
        input = reduced_data
        result = hw3.below_poverty_level_less_than(input, 0.0)
        expected = []
        self.assertEqual(expected, result)
